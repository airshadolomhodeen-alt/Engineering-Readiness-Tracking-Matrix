...
def load_pfez_data():
    ...
    amounts = (weights / weights.sum()) * 18_200_000_000.0  # Polloc Freeport Scale 18.2B PHP
...
st.markdown("""
    <div class="pfez-header">
        ...
        <p>Strategic Development & Investment Program (SDPIP) 2026-2031 — Executive Decision & Financial Forecast Dashboard</p>
    </div>
